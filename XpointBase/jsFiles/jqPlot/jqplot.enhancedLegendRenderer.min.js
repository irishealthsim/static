...
(function ($) {
  ...
  $.jqplot.EnhancedLegendRenderer.prototype.draw = function () {
    ...
    if (this.show) {
      ...
      /**********************custom code by Anirudh ***********Previously nothing was here*/
      if (this.extraCSS != null && $.isArray(this.extraCSS)) {
        $(this.extraCSS).each(function () {
          var css = this;
          if (css) {
            ss += css.key + ":" + css.value + ';';
          }
        });
      }
      /**********************end of custom code***********/
