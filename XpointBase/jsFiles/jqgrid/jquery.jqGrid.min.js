  ...
  $.fn.jqGrid = function (pin) {
    ...
    return this.each(function () {
      ...
      var sortkeys = ["shiftKey", "altKey", "ctrlKey"],
		...
		populate = function (npage) {
		  if (!ts.grid.hDiv.loading) {
		    ...
		    setTimeout(function () { endReq(); }, 500);
		  }
		},
      ...
      for (i = 0; i < this.p.colNames.length; i++) {
        ...
        var cname = ts.p.colModel[i].name; //CHANGES DONE BY ELEMENT8 TEAM
      ...
      //thead += imgs + "</div></th>";
      thead += imgs + "<span id='filter_" + cname + "' ></span></div></th>"; //CHANGES DONE BY ELEMENT8 TEAM
      }
      thead += "</tr></thead>";
      imgs = null;
      $(this).append(thead);

      //CHANGES DONE BY ELEMENT8 TEAM
      /*Custom ajax*/
      var columnName = [];
      $.ajax({
          url: "/_layouts/IImpact.Web/LifeCycleService.asmx/GetFilterColumn",
          dataType: 'json',
          data: '{}',
          type: 'POST',
          ...
          success: function (datap) {
              ...
              $.each(data, function (i) {
                  columnName.push(data[i]);
                  $("#filter_" + data[i]).addClass('ui-filter-icon');
              });
          }
      });
      //END Custom ajax
      ...
      $("th", thr).each(function (j) {
        ...
        //CHANGES DONE BY ELEMENT8 TEAM
        /**Advance filter functionality code**/
        var colIndex = $(this).attr("cellIndex");
        var colName = ts.p.colModel[colIndex].name;
        var colnm = $('div', this)[0].id;
        var sortId = $(this).attr("id");
        var ds = "filter_";
        var idxcol = 0; var reload, sor;
        var filterImageID = ds + colName;
        //Sorting functionality
        $("#sortFilterData").click(function () {
            sortData(colnm, idxcol, reload, sor);
        });
        ...
        $(".submitButton").click(function () {
            ...
            if (checkValues.length > 0) {
                $("#gs_" + ts.p.colModel[colIndex].name).val(checkValues);
                var columnName = ts.p.colModel[colIndex].name;
                $(ts).jqGrid("advanceFilterToolbar", p, columnName);
                $("#filterContainer").hide();
                $("#gs_" + ts.p.colModel[colIndex].name).val("");
            }
            else
                $("#filterContainer").hide();
        });
        ...
        /*END ADVANCE FILTER FUNCTIONALITY*/
      ...
      $(grid.hDiv)
			...
			.addClass("xp-OuterPanel ui-jqgrid-hdiv")
			.append(hb);
      $(hb).append(hTable);
      hTable = null;
      ...
      if (ts.p.pager) {
        ...
        $(ts.p.pager).css({ width: grid.width + "px" }).appendTo(eg).addClass('xp-OuterPanel ui-jqgrid-pager ui-corner-bottom');
      ...
      $(grid.cDiv).append(arf).append("<span class='ui-jqgrid-title" + (dir == "rtl" ? "-rtl" : "") + "'>" + ts.p.caption + "</span>")
		.addClass("ui-jqgrid-titlebar  ui-corner-top ui-helper-clearfix");
      ...
      if (ts.p.toppager) {
        ...
        $(grid.topDiv).insertBefore(grid.hDiv).addClass('xp-OuterPanel ui-jqgrid-toppager').width(grid.width);
...
(function ($) {
  ...
  **/
  ...
  $.jgrid.extend({
    ...
    //CHANGES DONE BY ELEMENT8 TEAM
    //this method is for Advance filtering functionality
    advanceFilterToolbar: function (p, columnName) {
      p = $.extend({
        autosearch: true,
        searchOnEnter: true,
        beforeSearch: null,
      ...
      if (p.stringResult === true || p.datatype == "local") {
        ...
        $.extend(p.postData, fdata);
      }
      var saveurl;
      if (p.searchurl) {
        saveurl = p.url;
        $($t).jqGrid("setGridParam", { url: p.searchurl });
      }
      var bsr = false;
...
; (function ($) {
  ...
  $.fmatter.util = {
    ...
    DateFormat: function (format, date, newformat, opts) {
      ...
      var dtNew = newformat.replace(token, function ($0) {
      ...
      return this.each(function () {
        ...
        if ($("#" + IDs.themodal).html() !== null) {
          ...
          var dh = isNaN(p.dataheight) ? p.dataheight : p.dataheight + "px",
				frm = ($.browser.msie && parseInt($.browser.version) === 7) ? $("<div name='FormPost' id='" + frmgr + "' class='FormGrid' onSubmit='return false;' style='width:100%;overflow:auto;position:relative;height:" + dh + ";'></form>").data("disabled", false) :
        $("<form name='FormPost' id='" + frmgr + "' class='FormGrid' onSubmit='return false;' style='width:100%;overflow:auto;position:relative;height:" + dh + ";'></form>").data("disabled", false),
    ...
    viewGridRow: function (rowid, p) {
      ...
      return this.each(function () {
        ...
        if ($("#" + IDs.themodal).html() !== null) {
          ...
          var dh = isNaN(p.dataheight) ? p.dataheight : p.dataheight + "px";
          var frm = ($.browser.msie && parseInt($.browser.version) === 7) ? $("<div name='FormPost' id='" + frmgr + "' class='FormGrid' style='width:100%;overflow:auto;position:relative;height:" + dh + ";'></div>") :
