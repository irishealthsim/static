...
function jqGridInclude() {
    var pathtojsfiles = "/_layouts/Relay/GridControl/js/"; // need to be ajusted
    ...
    var modules = [
        ...
        {include: true, incfile: 'JsonXml.js' }, //xmljson utils
         {include: true, incfile: 'jqModal.js' }, //jqmodel plugin
        {include: true, incfile: 'jquery.searchFilter.js' }, // search Plugin
        {include: true, incfile: 'json2.js' }, //string to object object to string
         {include: true, incfile: 'Relay/RelayGrid.js' }, //Custom Methods Extension
         {include: true, incfile: 'ui/jquery-ui.min.js' }, //for Jquery UI framework
           {include: true, incfile: 'Relay/ajaxupload.js' }, // for upload functionality
         {include: true, incfile: 'Relay/relayupload.js'} //for Upload functionality
    ];
    var filename;
