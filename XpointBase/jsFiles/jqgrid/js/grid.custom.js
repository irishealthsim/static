    ...
    $.fn.extend({
                    ...
                    $.each(self.p.filterModel, function(i, n) {
                        ...
                        switch (this.stype) {
                            ...
                            case 'text':
                                ...
                                var inputtext = $("<input autocomplete='off' type='text' name='" + (this.index || this.name) + "' id='sg_" + this.name + "' value='" + df + "'/>");
                                $(td).append(inputtext);
        ...
        filterToolbar: function(p) {
            ...
            return this.each(function() {
                ...
                $.each($t.p.colModel, function(i, n) {
                    ...
                    switch (this.stype) {
                        ...
                        case 'text':
                            ...
                            if (this.search) {
                                var inputtext = $("<input autocomplete='off' type='text' style='width:95%;padding:0px;' name='" + (cm.index || cm.name) + "' id='gs_" + cm.name + "' value='" + df + "'/>");
                                $(thd).append(inputtext);                              
                            }
                            else {
                                $(thd).append("<input autocomplete='off' type='text' disabled='disabled' style='background-color:gray;width:95%;padding:0px;' name='" + (cm.index || cm.name) + "' id='gs_" + cm.name + "' value='" + df + "'/>");
                            }
                ...
                this.removeUserAccess = function () { removeUserAccess(); };
            });
        }
    });
})(jQuery);