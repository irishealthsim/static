		...
		init: function(elem,settings) {
			...
			$(this.menu).find('li').each(function(){
				...
				if (childs.length > 0) {
					...
					$(this).children('a').append('<label class="arrow"></label>');
				}
				
				if($(this).hasClass('selected')){
					$(this).parent().parent('li.parent').addClass('selected-parent');
					$(this).parent().parent('li.parent').parent().parent('li.parent').addClass('selected-parent');
