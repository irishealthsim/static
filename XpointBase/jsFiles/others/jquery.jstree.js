        ...
        $.jstree.core.prototype = {
            ...
            init: function (el, options) {
                ...
                */
                ...
                this._data.core.original_container_html
                    ...
                    .remove();
                this.element.html("<" + "ul class='jstree-container-ul jstree-children' role='group'><" + "li id='j" + this._id + "_loading' class='jstree-initial-node jstree-loading jstree-leaf jstree-last' role='tree-item'><i class='jstree-icon jstree-ocl'></i><" + "a class='jstree-anchor' href='#'><i class='jstree-icon '></i>" + this.get_string("Loading ...") + "</a></li></ul>");
            ...
            */
            _parse_model_from_html: function (d, p, ps) {
                ...
                if (tmp.length) {
                    data.icon = tmp.hasClass('jstree-themeicon-hidden1') ? false : tmp.attr('rel');
                }
                if (data.state.icon) {
            ...
            */
            redraw_node: function (node, deep, is_callback, force_render) {
                ...
                if ((obj.icon && obj.icon !== true) || obj.icon === false) {
                    if (obj.icon === false) {
                        node.childNodes[1].childNodes[0].className += ' jstree-themeicon-hidden1';
            ...
            */
            refresh: function (skip_loading, forget_state) {
                ...
                if (!skip_loading) {
                    this.element.html("<" + "ul class='" + c + "' role='group'><" + "li class='jstree-initial-node jstree-loading jstree-leaf jstree-last' role='treeitem' id='j" + this._id + "_loading'><i class='jstree-icon jstree-ocl'></i><" + "a class='jstree-anchor' href='#'><i class='jstree-icon'></i>" + this.get_string("Loading ...") + "</a></li></ul>");
                    this.element.attr('aria-activedescendant', 'j' + this._id + '_loading');
                }
            ...
            */
            edit: function (obj, default_text) {
                ...
                */
                    ...
                    h2 = $("<" + "input />", {
                        "value": t,
                        //Added maxlength for folder name
                        "maxlength": "37",
            ...
            */
            hide_icon: function (obj) {
                ...
                obj.icon = false;
                this.get_node(obj, true).children(".jstree-anchor").children(".jstree-themeicon");
                return true;
            },
            /**
            ...
            */
            show_icon: function (obj) {
                ...
                dom.children(".jstree-anchor").children(".jstree-themeicon").removeClass('jstree-themeicon-hidden1');
                return true;
            }
        };
